  ...
  return (
    <div className="section">
      ...
      <div className="quiz-progress">
        ...
        <span className="quiz-progress-label">{numAnswered}/{quizQuestions.length}</span>
      </div>
                  ...
                  return (
                    ...
                    >
                      <span className="quiz-option-marker">
                        {show && correct ? "✓" : show && isSelected ? "✗" : String.fromCharCode(65 + oidx)}
                      </span>
                      {o.text}
                    </button>
                  );
      ...
      {done && (
        <div className="quiz-result">
          <div className="quiz-score">{numCorrect}/{quizQuestions.length}</div>
