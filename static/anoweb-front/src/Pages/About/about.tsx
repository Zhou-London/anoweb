...
export default function About() {
  return (
    <section className="rounded-3xl shadow-lg p-6 md:p-10 space-y-4" style={{ background: 'var(--gb-bg)', border: '1px solid var(--gb-border)' }}>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-2xl p-4" style={{ background: 'var(--gb-bg-soft)', border: '1px solid var(--gb-border)' }}>
