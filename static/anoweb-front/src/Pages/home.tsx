...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-start justify-start p-8 space-y-6 bg-gradient-to-r from-blue-100 to-purple-200">
      {/* Profile Card */}
      {profile ? (
