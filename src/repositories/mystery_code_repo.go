...
func (r *MysteryCodeRepository) CreateCode(code string) (*models.MysteryCode, error) {
...
func (r *MysteryCodeRepository) IsCodeValid(code string) (bool, error) {
	var count int64
	if err := r.db.Model(&models.MysteryCode{}).
...
func (r *MysteryCodeRepository) GetAllCodes() ([]models.MysteryCode, error) {
	var codes []models.MysteryCode
